...
- Несмотря на то, что ряд решений в дашборде выглядят неоптимально (и являются неоптимальными), требования к визуализации исходили от функционального заказчика, который принял именно такую структуру для презентации результатов и работы
